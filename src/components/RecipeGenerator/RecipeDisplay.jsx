      ...
      <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-8">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex space-x-3 ml-4">
            <button
              ...
              className={`px-6 py-3 font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed ${
                isSaved ? 'bg-green-600 hover:bg-green-600 text-white' : 'bg-yellow-500 hover:bg-yellow-600 text-gray-900'
              }`}
            >
              {saving ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          ...
          <div className="text-center p-4 rounded-lg">
            <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium border ${getDifficultyColor(recipe.difficulty)}`}>
              {recipe.difficulty}
            </div>
          ...
          <div className="space-y-3">
            {recipe.nutrition && Object.entries(recipe.nutrition).map(([key, value]) => (
              <div key={key} className="flex justify-between items-center">
                <span className="text-gray-400 capitalize bg-blue-500">
