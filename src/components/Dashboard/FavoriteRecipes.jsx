  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-gray-300">Loading your favorite recipes...</span>
      </div>
    );
  }
          ...
          <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-8">
            <div className="flex justify-between items-start mb-4">
              ...
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors ml-4"
              >
                ← Back to Favorites
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
              ...
              <div className="text-center p-3 rounded-lg">
                <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium border ${getDifficultyColor(selectedRecipe.recipe_data.difficulty)}`}>
...
<div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
  ...
  <div className="space-y-3">
    {selectedRecipe.recipe_data.nutrition &&
      Object.entries(selectedRecipe.recipe_data.nutrition).map(([key, value]) => {
        // Assign background colors for each nutrition type
        const bgColors = {
        ...
        return (
          ...
          >
            ...
            {/* Tips */}
            {selectedRecipe.recipe_data.tips && selectedRecipe.recipe_data.tips.length > 0 && (
              <div className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6">
                <h2 className="text-xl font-bold text-white mb-4">
                  💡 Tips
                </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {recipes.map((recipe) => (
            <div key={recipe.id} className="bg-gray-800 rounded-xl shadow-lg border border-gray-700 p-6 hover:shadow-xl transition-all duration-300 hover:border-blue-500 cursor-pointer">
              <div onClick={() => setSelectedRecipe(recipe)}>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getDifficultyColor(recipe.recipe_data.difficulty)}`}>
